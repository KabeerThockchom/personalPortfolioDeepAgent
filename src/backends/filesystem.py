...
from .protocol import WriteResult, EditResult
...
class FilesystemBackend:
    ...
    def __init__(
        ...
        Args:
            ...
            virtual_mode: If True, treat paths as virtual (sandboxed to root_dir)
            max_file_size_mb: Maximum file size for grep operations (default: 10MB)
        """
