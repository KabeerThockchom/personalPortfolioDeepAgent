#!/usr/bin/env python3
"""
MCP Server for Cash Flow Analysis Tools

Exposes cash flow calculation tools as MCP tools.
Includes: monthly cash flow analysis, savings rate calculation,
expense categorization, future cash flow projections, and burn rate analysis.
"""
...
# Create MCP server
mcp = FastMCP("Cash Flow Analysis")


def _sum_nested_dict(d):
    """Helper to sum values in nested dictionaries."""
    total = 0
