#!/usr/bin/env python3
"""
MCP Server for Goal Planning Tools

Exposes goal planning and retirement calculation tools as MCP tools.
Includes: retirement gap analysis, Monte Carlo simulations, FIRE calculations,
college funding projections, and required savings rate calculations.
"""
